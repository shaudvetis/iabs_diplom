...
@section('content')
    ...
    <ul class="nav justify-content-end">
        <li class="nav-item">
         <a class="nav-link active" href="{{asset('archiv_nightwork')}}">Архив</a>
        </li>
    </ul>
        ...
        <!-- /.card-header -->
         <div class="card-body">
                   ...
                   {!! Form::label('fio', 'ФІО хворого') !!}
                    ...
                    <div class="form-group">
                        {!! Form::label('date_arrival', 'Дата госпіталізаціїє') !!}
                        {!! Form::date('date_arrival', null, ['class' => 'col-4']) !!}
                    </div>

                    <div class="form-group">
                        {!! Form::label('time_arrival', 'Час госпіталізації') !!}
                        {!! Form::time('time_arrival', null, ['class' => 'col-4']) !!}
                    </div>
