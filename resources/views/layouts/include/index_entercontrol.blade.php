<table class="table table-sm">
   ...
   <th style="font-size:small;">Курація хворого</th>
   ...
   <th style=" font-size:small;padding-top:50px">20-16-12-8</th>
...
@foreach($direction as $user_inf1)
 ...
 @php if(empty($user_inf1->max)) $user_infmax = 1 ; else $user_infmax = $user_inf1->max; @endphp

  <td><?php $y=($user_inf->suma1+$user_inf->suma+$user_inf->suma3); $x=$y*100/$user_infmax;  if (($x<=$user_inf1->all_control5)&&($x>=$user_inf1->all_control6))
 {
 echo ceil($x).'%'.' '.'A';
...
elseif ($x<=$user_inf1->all_control20) {
 ...
 <td> <?php 
 $y=($user_inf->suma1+$user_inf->suma+$user_inf->suma3); $x=$y*100/$user_infmax;
