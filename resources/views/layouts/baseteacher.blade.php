...
<head>
  ...
  <!-- Подключили вівод календаря css-->
...
<div class="brand-link" style="height: 110px;">
   @if(Auth::user()->role==4 )
    <ul>
      ...
      <li>
        <a href="{{asset('intern.students')}}" style="color: white" ><i>Кабінет Інтерна</i></a></li>
...
<li class="nav-item has-treeview menu-close">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{asset('admink.kerivnuk.name_seminar')}}" class="nav-link">

                  <!--<a href="/admink/courseone" class="nav-link"> -->
                  <i class="far fa-circle nav-icon"></i>
                  <p>Семінари та теми</p>
                </a>
              </li>
            </ul> 
          <li class="nav-item has-treeview menu-close">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('zvitthreecourse')}}" class="nav-link">

                  <!--<a href="/admink/courseone" class="nav-link"> -->
                  <i class="far fa-circle nav-icon"></i>
                  <p>Третій курс усі оцінки</p>
                </a>
              </li>
            </ul>
