...
<div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
 <div class="row">
  ...
  <form  role="form" method="post" action="{{asset('cherevnaocho')}}">
    {{ csrf_field() }}
 <p>Оберіть період с: <input type="date" name="calendar_start">
  по: <input type="date" name="calendar_end">
...
<div class="tab-pane fade" id="nav-night" role="tabpanel" aria-labelledby="nav-night-tab">
  ...
  <div class="card card-danger">
      <div class="card-header">
        <h3 class="card-title">Сумарні бали за всіма видами контролю та ранжування за системою ЕСТS за модулем 1.</h3>
 ...
 <div class="table-responsive">
        <table class="table table-bordered table-striped table-highlight">
            <thead>
                <th style="width: 80px">ПІБ</th>
                <th style="width: 80px"><center>Семінар 1</center></th>
                <th style="width: 80px">Семінар 2</th>
                <th style="width: 100px">Семінар 3</th>
                <th style="width: 100px">Сумарне</th>
            </thead>
            <tbody>
...
<div class="card card-danger">
 ...
 <div class="table-responsive">
        <table class="table table-bordered table-striped table-highlight">
            <thead>
                <th style="width: 80px">Учбовий елемент</th>
                <th style="width: 400px; font-size: 2em"><center>Теми семінарів</center></th>
                <th style="width: 100px">Отримана оцінка</th>
            </thead>
            <tbody>
