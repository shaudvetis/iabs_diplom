...
@include('admink.include.naprav_settings.course_select') 
 ...
 <a href="{{asset('opikuclinobs')}}">Клінічне обстеження хворого</a>
 <p> <a href="{{asset('admink.controlmodyl.model_opiku')}}">Контроль модуля</a></p>
 </div>
 </div>
...
@endforeach
 ...
 <!--    <th >K</th> -->
  ...
  <tr>
      <form role="form" method="post"  action="{{route('opiku.store')}}">
               {{ csrf_field() }}  
