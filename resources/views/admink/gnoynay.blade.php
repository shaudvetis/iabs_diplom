...
<a href="{{asset('gnoynayaclinobs')}}">Клінічне обстеження хворого</a>
<p> <a href="{{asset('admink.controlmodyl.model_gnoynaya')}}">Контроль модуля</a></p>
</div>
</div>
...
@endforeach
 ...
 <!--    <th >K</th> -->
  ...
  <tr>
      <form role="form" method="post"  action="{{route('gnoynay.store')}}">
               {{ csrf_field() }}  
