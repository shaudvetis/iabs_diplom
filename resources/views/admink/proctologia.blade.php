...
@include('admink.include.naprav_settings.course_select')
  ...
  <a href="{{asset('proctologiaclinobs')}}">Клінічне обстеження хворого</a>
  <p> <a href="{{asset('admink.controlmodyl.model_proctologia')}}">Контроль модуля</a></p>
</div>
</div>
...
@endforeach
 ...
 <!--    <th >K</th> -->
  ...
  <tr>
      <form role="form" method="post"  action="{{route('proctologia.store')}}">
               {{ csrf_field() }}  
