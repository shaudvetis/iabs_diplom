...
@include('admink.include.naprav_settings.course_select') 
 ...
 <a href="{{asset('urologiyaclinobs')}}">Клінічне обстеження хворого</a>
 <p> <a href="{{asset('admink.controlmodyl.model_urologiya')}}">Контроль модуля</a></p>
 </div>
 </div>
...
@endforeach
 ...
 <!--    <th >K</th> -->
  ...
  <tr>
      <form role="form" method="post"  action="{{route('urologiya.store')}}">
               {{ csrf_field() }}  
