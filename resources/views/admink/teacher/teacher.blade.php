...
<!--     <a href="{{asset('sprav_rozklad')}}" class="text" data-toggle="tooltip" data-placement="top" title="Всередині опис роботи">
           <div class="btn-sm" style="width: 200px">
            ...
            <div class="small-box bg-orange">
              <div class="inner" style="height:90px">
                <h6>Формування розкладу Очно</h6>
              </div>
              <div class="icon">
                <i class="fas fa-comments"></i>
             </div>
...
<!--       <a href="{{route('rozkladz')}}" class="text" data-toggle="tooltip" data-placement="top" title="Всередині опис роботи">
           <div class="btn-sm" style="width: 200px">
             small box 
            <div class="small-box bg-danger">
              <div class="inner" style="height:90px">
                <h6>Формування розкладу Заочно</h6>
              </div>
              <div class="icon">
                <i class="fas fa-comments"></i>
             </div>
 ...
 <!--     <a href="{{url('planrozklad')}}" class="text" data-toggle="tooltip" data-placement="top" title="Всередині опис роботи">
           <div class="btn-sm" style="width: 200px">
            small box 
  ...
  <!--    <a href="{{asset('cherguvannya')}}" class="text" data-toggle="tooltip" data-placement="top" title="Всередині опис роботи">
           <div class="btn-sm" style="width: 200px">
             small box 
            <div class="small-box bg-purple">
              <div class="inner" style="height:90px">
                <h6>Формування чергувань</h6>
              </div>
              <div class="icon">
                <i class="fas fa-comments"></i>
             </div>
