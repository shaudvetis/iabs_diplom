...
@include('admink.include.naprav_settings.course_select')
  <div class="card-tools" >
   <a href="{{asset('vascularclinobs')}}">Клінічне обстеження хворого</a>
   <p> <a href="{{asset('admink.controlmodyl.model_vascular')}}">Контроль модуля</a></p>
   </div>
 </div>
...
<tr>
  ...
  <th style="height: 10px">Семінар2</th>
  <th style="height: 10px">Семінар3</th>
  <th style="height: 10px">Семінар4</th>
 </tr>
...
@endforeach
 ...
 <!--    <th >K</th> -->
  ...
  <tr>
   <form role="form" method="post"  action="{{route('vascular.store')}}">
           {{ csrf_field() }}  
