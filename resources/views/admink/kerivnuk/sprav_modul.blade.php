...
<nav>
 ...
 <table style="width: 75%" class="layer ">
   <tr>
   <th>№</th>
   <th style="text-align: left;width:20%;">Напрямок</th>
   ...
   <th style="text-align: center;">Днів в семінарі</th>
...
<tr>
  <input type="hidden" name="id" value="{!!$naprs->id!!}">
    ...
    <td style="text-align: center;"><input type="text" name="name" value="{!!$naprs->name_napravlenie!!}" size="auto"> </td>
    ...
    <td style="text-align: center;"><input type="text" value="{!!$naprs->in_days!!}" size="5px"> </td>
