        ...
        <div class="card card-success">
          ...
          <div class="row" >
           ...
           @endcomponent      
              ...
              <div id='Label11' style='display: none;width:350px;margin-left: 5px'>
                 <label>Назва навички</label>
                  <select name="pract_amsurgery" class="form-control select2" style="width: 100%">
                  <option >  </option>
                  <option > Операції при фурункулах, карбункулах, гідраденітах</option>
                  <option > Розкриття абсцесів підшкірної клітковини</option>
                  <option > Операції при підшкірному, шкірному панариції, пароніхії</option>
                  <option > Операції при сухожильному і кістковому панариціях, розкриття гнійників</option>
                  <option > Видалення чужорідних тіл з м’яких тканин</option>
                  <option > Видалення доброякісних пухлин м’яких тканин (атером, ліпом, фібром,гігром)</option>
                  <option> Заповнення лікарняного листка</option>
                  <option >  Оформлення медичної документації лікаря хірургічного кабінету полікліники</option>
                  </select>
                </div>
