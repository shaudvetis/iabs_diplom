...
class UserProfile extends Model
{
    ...
    protected $fillable = ['user_id', 'decatki', 'surname', 'name', 'lastname', 'gender', 
    'surnamefirst', 'fullname_en','kafedra','fl_norm','date_bak','course',
    ...
    {
        return $this->hasMany(OcenkiTables::class);
    }
     public function controlmodyl()
    {
        return $this->hasOne('App\Controlmodyl');
    }
    public function cherevnas()
    {
        return $this->hasOne('App\Admink\Model\Cherevna');
    }
}
