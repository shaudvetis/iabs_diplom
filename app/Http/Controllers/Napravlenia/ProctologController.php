...
class ProctologController extends Controller
{
    /**
     ...
     */
    public function indexProctologia()
    {
...
$nightpractic = Nightpractic::where('id_student', $currentUser->id)->get();
    foreach ($nightpractic as &$nightpract) {
      $nightpract->user = User::find($currentUser->id);
        ...
        return view('napravlenia.proctologia', compact('forms', 'formssurgeryday', 'formspracticeday', 'seminar'));
    }
 }