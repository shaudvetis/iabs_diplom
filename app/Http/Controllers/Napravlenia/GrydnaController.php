...
class GrydnaController extends Controller
{
    /**
...
->get();
      ...
      ->Where('direction', 'Грудна клітина')
      ->get();
...
$nightpractic = Nightpractic::where('id_student', $currentUser->id)->get();
    foreach ($nightpractic as &$nightpract) {
      $nightpract->user = User::find($currentUser->id);
        ...
        return view('napravlenia.grudna_klituna', compact('forms', 'formssurgeryday', 'formspracticeday', 'seminar'));
    }
